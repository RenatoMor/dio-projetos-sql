...
- [Banco de Dados E-COMMERCE](#banco-de-dados-e-commerce-scroll)
- [Introdução](#introdução-writing_hand)
- [Instruções de Uso](#instruções-de-uso-computer)
- [Entidades Principais](#entidades-principais-card_file_box)
- [Tabelas de Cliente](#tabelas-de-cliente-client)
- [Tabelas de Produto](#tabelas-de-produto-package_box)
- [Tabela de Pagamento](#tabela-de-pagamento-credit_card)
- [Tabela de Pedido](#tabela-de-pedido-shopping_cart)
- [Tabela de Estoque](#tabela-de-estoque-package_with_arrow)
- [Tabela de Fornecedor](#tabela-de-fornecedor-factory)
- [Tabela de Vendedor_Terceiro](#tabela-de-vendedor_terceiro-seller)
- [Tabela de Transportadora](#tabela-de-transportadora-truck)
- [Tabela de Entrega](#tabela-de-entrega-package_delivery)
- [Tabela de Produto_Vendedor](#tabela-de-produto_vendedor-seller_package)
